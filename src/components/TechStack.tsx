...
export function TechStack() {
  ...
  return (
    <section className="page-shell py-12 md:py-20">
      <motion.div
        className="overflow-hidden rounded-[24px] sm:rounded-[32px] bg-[#0a0a0a] px-5 py-10 sm:px-8 sm:py-14 md:px-12 md:py-18 lg:px-16 text-white border border-white/10"
