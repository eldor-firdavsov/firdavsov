...
export const metadata: Metadata = {
  ...
  description:
    "Official portfolio of Firdavsov Eldor, known internationally as Eldor Firdavsov (firdavsov.uz) — Senior Frontend Developer & AI/ML Engineer based in Samarkand, Uzbekistan. Building high-performance web products, interactive UI, and machine learning applications.",
  keywords: [
    "Firdavsov Eldor",
    "firdavsov eldor",
    "Eldor Firdavsov",
    ...
    "firdavsov developer uzbekistan",
    "frontend developer",
    "fullstack developer",
  ...
  return (
    ...
    >
      <head>
        ...
        <link rel="author" href="https://www.firdavsov.uz/about" />
